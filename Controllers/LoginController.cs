    ...
    public class LoginController : Controller
    {
        ...
        private LoginUserModel CheckInputValuesForLogin(LoginModel loginModel)
        {
            try
            {
                ...
                // ログインユーザー情報取得
                List<M_User> mUsers = LoginController.GetUserToLoginAndCheckPassword(loginId);
        ...
        public static List<M_User> GetUserToLoginAndCheckPassword(string loginId)
        {
            try
            {
                // SQL作成
                ...
                // DB接続
                List<M_User> userList = M_UserConnectController.ConnectMUsers(sql);
                return userList;
            }
            catch (Exception)
            {
