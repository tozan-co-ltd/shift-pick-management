    ...
    public class M_NotificationController : BaseController
    {
        ...
        public JsonResult ExportFile(string gamenName, bool isBeforeNotificationPeriod, List<string> checkedDepos)
        {
            ...
            try
            {
                ...
                {
                    // Excelファイル作成チェック
                    var createRs = CreateFile.CheckCreateExcel(mNotificationConvertedDT, rNotificationUserDT, tmpFilename, sheetTwo, sheetNameOne, sheetNameTwo, gamenName, checkedDepos);
