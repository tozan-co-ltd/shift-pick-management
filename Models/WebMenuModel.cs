...
namespace ai_truck_load_measurement.Models
{
    ...
    public class WebMenuModel : CommonModel
    {
        private readonly List<M_WebMenu> referenceList = new List<M_WebMenu>()
        {
            ...
            new M_WebMenu{CategoryID = 5, MenuID = 1, MenuName = "日次出発実績無データ", Controller = "NonDepartedAtRecord", Action = "Index"},
            new M_WebMenu{CategoryID = 5, MenuID = 2, MenuName = "紐づけ切れ実績 識別番号有", Controller = "NonTripNameRecord", Action = "Index"},
            new M_WebMenu{CategoryID = 5, MenuID = 3, MenuName = "紐づけ切れ回数", Controller = "CountNonTripNameRecord", Action = "Index"},
            new M_WebMenu{CategoryID = 5, MenuID = 4, MenuName = "紐づけ切れ実績 識別番号無", Controller = "NonIdentifyNumberRecord", Action = "Index"},
        };
